...
This project focuses on analyzing Retail Sales Data to uncover insights about revenue performance, customer purchasing behavior, competition intensity, discounts, and seasonal trends.

Through detailed data cleaning, feature engineering, and visualization, the goal is to identify key business factors influencing sales growth and profitability.

**🎯 Objective**

To perform Exploratory Data Analysis (EDA) on retail sales data and derive meaningful insights that support data-driven business decisions.
